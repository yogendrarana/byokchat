...
function RouteComponent() {
    ...
    function handlePasswordChange() {
        ...
        try {
            ...
            toast.error("Error", {
                description:
                    err?.message || err?.message?.data || "Something went wrong. Please try again."
            });
        }
    }
                            ...
                            <div className="grid md:grid-cols-2 gap-4 items-start">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        ...
                                        anytime by logging back in. Your data will be preserved but
                                        your account will be hidden from other users.
                                    </p>
                                </div>
                            ...
                            <div className="grid md:grid-cols-2 gap-4 items-start">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        ...
                                        This action cannot be undone. All your files, settings, and
